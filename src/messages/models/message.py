...
class Message(UUIDModel, HistoryModel, DeletedModel):
    ...
    type = models.CharField(
        max_length=40, choices=MessageType.choices, default=MessageType.MESSAGE, null=False, db_index=True
    )
    subtype = models.CharField(
        max_length=40, choices=MessageSubType.choices, default=MessageSubType.EMPTY, db_index=True
    )
